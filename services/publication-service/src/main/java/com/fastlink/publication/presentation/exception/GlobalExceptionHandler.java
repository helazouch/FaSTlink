package com.fastlink.publication.presentation.exception;

import com.fastlink.publication.application.exception.ConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleUnexpected(Exception ex, HttpServletRequest request) {
        LOGGER.error("Unexpected publication-service error on {}", request.getRequestURI(), ex);
