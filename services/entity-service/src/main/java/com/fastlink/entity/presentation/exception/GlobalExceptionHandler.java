package com.fastlink.entity.presentation.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleIdentity(IdentityValidationException ex, HttpServletRequest request) {
